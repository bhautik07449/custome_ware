  ...
  return (
    <div className="bg-background text-on-background min-h-[100dvh] flex flex-col items-center overflow-x-hidden font-body-md w-full">
      ...
      <main className="flex-grow w-full max-w-md px-6 pt-32 pb-12 flex flex-col mx-auto">
        ...
        <div className="w-full h-40 md:h-48 rounded-xl overflow-hidden mb-xl bg-surface-container-low border border-outline-variant/20 hidden md:block">
          <img
        ...
        <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="space-y-2">
            <label className="font-label-md text-label-md text-on-surface px-1 font-bold" htmlFor="email">Email Address</label>
            <div className="relative group">
          ...
          <div className="space-y-2">
            <label className="font-label-md text-label-md text-on-surface px-1 font-bold" htmlFor="mobile">Mobile Number</label>
            <div className="relative group">
          ...
          <div className="space-y-2">
            <label className="font-label-md text-label-md text-on-surface px-1 font-bold" htmlFor="password">Password</label>
            <div className="relative group">
          ...
          <button className="w-full h-14 mt-4 bg-primary text-on-primary rounded-xl font-label-md text-label-md hover:bg-secondary active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-secondary/30" type="submit">
            Create Account
        ...
        <div className="mt-auto pt-lg text-center">
          <p className="font-body-md text-body-md text-on-surface-variant">
            ...
            <Link className="text-secondary font-bold hover:underline transition-all decoration-2 underline-offset-4 ml-2" to="/login">Login</Link>
          </p>
        </div>
      </main>
    </div>
