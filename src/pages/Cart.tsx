            ...
            {currentStep === 1 && (
              <section className="step-content space-y-md fade-in">
                ...
                <div className="space-y-md">
                  ...
                  <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-xl p-md flex flex-row gap-md sm:gap-lg hover:shadow-lg hover:shadow-on-surface/5 transition-all duration-300 shadow-sm md:shadow-none">
                    <div className="w-24 sm:w-32 h-24 sm:h-32 bg-surface-container-low rounded-lg flex-shrink-0 relative overflow-hidden">
                      <img className="w-full h-full object-cover" alt="Custom T-Shirt" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC_rv9aovCvCX1U8io62k2ZU3vSVqmyKEMz4zOouy_8A1F84W0pEziS6tlp_baKa-0hu2r61PW5ClGjxYm3UUvxtQI-q1r803nFqnlqiNdL7h6Hq8nrUpTOPkwr3vEEhE4WrYHA-X14RjPoEvKdubg4UP7YHRTM4OSpaVfqjbcaEcSn66Od2lc1XDEKiHFxw07gGcDbnOLkk7nUafao-v13vKf1CHnBZpH3Q8CeQcnwsLI8kYp2UA2CjgXtoX1I21OsjQnSI0thIoA" />
                      <div className="absolute top-1 right-1 bg-secondary/90 text-on-secondary px-1.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider">Custom</div>
                    </div>
                    <div className="flex-1 flex flex-col justify-between">
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="font-label-md md:font-headline-md text-label-md md:text-body-lg font-bold text-on-surface">Essential Heavyweight Tee</h3>
                          <p className="font-label-sm md:font-body-md text-label-sm text-on-surface-variant">Size: L • Color: Off-White</p>
                        </div>
                        <span className="hidden md:inline font-headline-md text-body-lg font-bold text-secondary">$45.00</span>
                      </div>
                      <div className="flex justify-between items-center mt-sm md:mt-md">
                        ...
                        <span className="md:hidden font-headline-md text-label-md text-on-surface font-bold">$45.00</span>
                  ...
                  <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-xl p-md flex flex-row gap-md sm:gap-lg hover:shadow-lg hover:shadow-on-surface/5 transition-all duration-300 shadow-sm md:shadow-none">
                    <div className="w-24 sm:w-32 h-24 sm:h-32 bg-surface-container-low rounded-lg flex-shrink-0 relative overflow-hidden">
                      <img className="w-full h-full object-cover" alt="Custom Hoodie" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBEEfAt-1yMMJmItCPKgan8hjGieOZL_-1YT4IOBs3LZSseJxDQ1DXq4BuDaqFw9NwjC5cWW7xobFMDsGJK8Z4MwNR_y0VqxeBT6YmODg_HCsli6tj6fieOLDHQD4jMJ3Nz6uzcRtWMniHnRooKJ322fd5GuuzHstF_smvcPhy6HtAj2Lri81sPO3Zthm4fQMEC0co46DigN5kUBLhLISbA0dJspwzq1eBkbp7VTCLyG8rLX9POR2iaeb9P-b_ZiY5-P1YAeee9pG8" />
                      <div className="absolute top-1 right-1 bg-secondary/90 text-on-secondary px-1.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider">Custom</div>
                    </div>
                    <div className="flex-1 flex flex-col justify-between">
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="font-label-md md:font-headline-md text-label-md md:text-body-lg font-bold text-on-surface">Premium Oversized Hoodie</h3>
                          <p className="font-label-sm md:font-body-md text-label-sm text-on-surface-variant">Size: XL • Color: Midnight Gray</p>
                        </div>
                        <span className="hidden md:inline font-headline-md text-body-lg font-bold text-secondary">$85.00</span>
                      </div>
                      <div className="flex justify-between items-center mt-sm md:mt-md">
                        <div className="flex items-center gap-md border border-outline-variant rounded-full px-sm py-[2px]">
                          <button className="w-8 h-8 flex items-center justify-center text-on-surface-variant active:scale-75 transition-transform"><span className="material-symbols-outlined text-sm font-bold">remove</span></button>
                        ...
                        <span className="md:hidden font-headline-md text-label-md text-on-surface font-bold">$85.00</span>
                        <button className="hidden md:flex text-error font-label-md text-label-md items-center gap-xs hover:underline">
                          <span className="material-symbols-outlined text-md">delete</span>
                          Remove
                        </button>
                ...
                <section className="pt-lg md:hidden">
                  ...
                  <div className="flex gap-md overflow-x-auto no-scrollbar pb-md -mx-md px-md">
                    <div className="bg-surface-container-high rounded-xl p-md min-w-[140px] flex flex-col gap-sm flex-shrink-0">
                      <div className="w-full aspect-square bg-surface-container-lowest rounded-lg overflow-hidden border border-outline-variant/20">
                        <img className="w-full h-full object-cover" alt="Organic Socks" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA8BiDPg4BD1WKcsaacSE2guM23wepfsNnCOYBaBqFtDx5UQHjaneWZk8MicLDP2XN-vRK1HSaJDQeRvuLUYV6IOIznUrnPViMDeAUPFTizOxV8npQi9lhg8em6xMMsTTp99RncSnBrfPACVLEHhEOfa1Itrx4dEzsa3oma5qPmEVXtjVROEHfOTW9KEPaZrVbgVVA2b7Bt5-A9FFwESSjdl2u3lvcS-iIsoMb_msdV_G25RO0oaKVfI6Sxr0IaH13di9i7mYItdM8" />
                      </div>
                      <span className="font-label-sm text-label-sm text-on-surface block truncate">Organic Socks</span>
                      <span className="font-label-sm text-label-sm font-bold">$12.00</span>
                    </div>
                    <div className="bg-surface-container-high rounded-xl p-md min-w-[140px] flex flex-col gap-sm flex-shrink-0">
                      <div className="w-full aspect-square bg-surface-container-lowest rounded-lg overflow-hidden border border-outline-variant/20">
                        <img className="w-full h-full object-cover" alt="6-Panel Cap" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAJ9Mf-WdvkJBSzmp4WBw-Z0XKhmDyFEFkBstH3TuDCwWvsyEtMWALufi4B8Sr0-6qEFrTSSgAXntnrg-M-L7IG3yum5pFnl9rmKUgXDP7t4z0nsMi-loaBTBnaLQu_yAhjijaW161eAY_YmweTSCobyd5R3QlTjoaRJXfMuOdR2GLF9GhRvgP044uL_FBDdp2UX9ACjtNR-jl-6vcjaQFAYN0jCycWXNG4axsoQvhy9JI5q0xGK2EnmQzHgyMh6L2pE4vfzejjOS8" />
                      </div>
                      <span className="font-label-sm text-label-sm text-on-surface block truncate">6-Panel Cap</span>
                      <span className="font-label-sm text-label-sm font-bold">$28.00</span>
                    </div>
                  </div>
                </section>
