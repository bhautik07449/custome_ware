...
export default function HeroSection() {
  return (
    <>
      <section className="relative min-h-[600px] hidden md:flex items-center overflow-hidden bg-surface">
        <div className="max-w-7xl mx-auto px-grid-margin grid grid-cols-1 lg:grid-cols-2 gap-2xl items-center relative z-10">
          <div className="space-y-xl animate-fade-in">
            ...
            <div className="flex flex-wrap gap-md">
              <Link to={PATHS.DESIGNER} className="bg-primary text-on-primary px-3xl py-md rounded-full font-label-md text-label-md hover:bg-secondary transition-all transform active:scale-95 text-center">
                Start Designing
              </Link>
      ...
      <section className="px-md py-xl flex flex-col items-center text-center md:hidden">
        ...
        <div className="relative w-full aspect-square bg-surface-container-low rounded-xl overflow-hidden mb-xl border border-outline-variant/30">
          ...
          <div className="absolute bottom-md left-md right-md flex justify-center">
            <Link to={PATHS.DESIGNER} className="w-full bg-primary text-on-primary py-md rounded-lg font-label-md text-label-md flex items-center justify-center gap-sm active:scale-95 transition-transform">
              Start Designing
