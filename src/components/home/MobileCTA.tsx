...
export default function MobileCTA() {
  return (
    <section className="px-md py-3xl text-center md:hidden">
      ...
      <Link to={PATHS.DESIGNER} className="inline-block w-full bg-primary text-on-primary py-xl rounded-xl font-label-md text-headline-md shadow-lg active:scale-95 transition-all">
        Launch Designer
      </Link>
    </section>
  );
